...
public class Keybinds extends HudElement {
    ...
    private final Setting<Boolean> blur = this.sgGeneral.booleanSetting("Blur Effect", true, "Applies a blur effect to the background for increased visual separation.");
