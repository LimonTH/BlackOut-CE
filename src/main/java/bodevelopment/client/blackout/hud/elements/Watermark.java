...
public class Watermark extends HudElement {
    ...
    private final TextColorMultiSetting textColor = TextColorMultiSetting.of(this.sgGeneral, () -> this.mode.get() == Mode.Clean || this.mode.get() == Mode.Simple || this.mode.get() == Mode.Exhibition || this.mode.get() == Mode.KassuK, "Primary");
    private final Setting<BlackOutColor> secondaryColor = this.sgGeneral.colorSetting("Accent Color", new BlackOutColor(255, 255, 255, 255), "The color used for version numbers or secondary text elements.", () -> this.mode.get() == Mode.Simple || this.mode.get() == Mode.Exhibition);
    private final Setting<Boolean> blur = this.sgGeneral.booleanSetting("Blur Effect", true, "Applies a blur effect to the background for improved contrast.", () -> this.mode.get() == Mode.Clean || this.mode.get() == Mode.KassuK);
    ...
    private final Setting<Boolean> bold = this.sgGeneral.booleanSetting("Bold Text", true, "Utilizes a thicker font weight for the client name.", () -> this.mode.get() == Mode.Simple);
