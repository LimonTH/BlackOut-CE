...
public class Watermark extends HudElement {
    ...
    private final TextColorMultiSetting textColor = TextColorMultiSetting.of(this.sgGeneral, () -> this.mode.get() == Mode.Clean || this.mode.get() == Mode.Simple || this.mode.get() == Mode.Exhibition || this.mode.get() == Mode.KassuK, "Primary Color");
