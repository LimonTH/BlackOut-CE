...
public class GuiSettings extends SettingsModule {
    ...
    public final Setting<Integer> selectorGlow = this.sgStyle.i("Selector Glow", 0, 0, 5, 1,
            "The intensity of the outer glow effect for the selection bar.", this.selectorBar::get);
    public final Setting<BlackOutColor> selectorColor = this.sgStyle.c("Selector Color", new BlackOutColor(40, 40, 40, 255),
    ...
    public final Setting<Double> moduleX = this.sgOpen.d("Module X", 0.5, 0.0, 1.0, 0.01,
    ...
    public final Setting<Double> moduleXClosed = this.sgClosed.d("Closed Module X", 0.5, 0.0, 1.0, 0.01,
