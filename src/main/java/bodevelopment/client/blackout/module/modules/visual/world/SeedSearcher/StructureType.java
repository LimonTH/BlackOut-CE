...
public enum StructureType {
    ...
    // Nether
    NETHER_FORTRESS("Nether Fortress", 27, 4, 30084232, false, 1.0F, new Color(200, 50, 50), biomes(Biomes.NETHER_WASTES, Biomes.SOUL_SAND_VALLEY, Biomes.WARPED_FOREST, Biomes.CRIMSON_FOREST, Biomes.BASALT_DELTAS), "textures/map/structures/nether_fortress.png"),
    BASTION_REMNANT("Bastion Remnant", 27, 4, 30084232, false, 1.0F, new Color(50, 50, 50), biomes(Biomes.NETHER_WASTES, Biomes.SOUL_SAND_VALLEY, Biomes.WARPED_FOREST, Biomes.CRIMSON_FOREST), "textures/map/structures/bastion/bastion_treasure.png"),
    ...
    // Features
    DUNGEON("Dungeon", 0, 0, 0, false, 1.0F, new Color(140, 100, 60), biomes(Biomes.LUSH_CAVES, Biomes.DRIPSTONE_CAVES, Biomes.DEEP_DARK), "textures/map/structures/dungeon/dungeon_skeleton.png"),
    ...
    LAVA_POOL_CAVE("Lava Pool (Cave)", 0, 0, 0, false, 1.0F, new Color(200, 50, 10), biomes(Biomes.LUSH_CAVES, Biomes.DRIPSTONE_CAVES, Biomes.DEEP_DARK), "textures/map/structures/lava_pool/lava_pool_cave.png"),
